...
## Project Structure
    ...
    ├── buildwebappdeep_dev_42757  # Django project configurations
...
1. Clone this repo and `cd buildwebappdeep_dev_42757`
...
2. Clone this repo and `cd buildwebappdeep_dev_42757`
